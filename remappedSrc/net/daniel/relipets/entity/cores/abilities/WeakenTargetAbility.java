...
public class WeakenTargetAbility implements CoreAbility {
    @Override
    public void start(CoreAbilityStats stats, BaseCore core) {
        ...
        if(attackTarget != null){
            attackTarget.addStatusEffect(
                    new StatusEffectInstance(StatusEffects.WEAKNESS, Utils.secondToTick(5 * stats.getAbilityDuration()), Math.round (1 * stats.getAbilityStrength())));
        }

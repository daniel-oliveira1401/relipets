...
public class RelipetsEntityRegistry {
    ...
    private static final String YELLOW_CORE_ID = "yellow_core";
    public static final String YELLOW_CORE_PATH = "pets/" + YELLOW_CORE_ID;
    ...
    public static final EntityType<YellowCore> YELLOW_CORE = Registry.register(
            Registries.ENTITY_TYPE,
            Identifier.of(Relipets.MOD_ID, YELLOW_CORE_PATH),
            EntityType.Builder.create(YellowCore::new, SpawnGroup.CREATURE).setDimensions(1, 2).build(YELLOW_CORE_ID)
    );
    ...
    public static void onInitialize() {
        ...
        FabricDefaultAttributeRegistry.register(RelipetsEntityRegistry.YELLOW_CORE, BaseCore.createBaseCoreAttributes());
    }
}
